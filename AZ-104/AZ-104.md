A lot of people have been asking me for a study guide for teh new Azure Exams. I decided I would start on the Az-104 (Microsoft Azure Administrator). AT the time of writing this guide the exam is not even out. The Beta should be coming soon around the end of March 2020. The old Exam az-103 will still be around for 90 days after the az-104 becomes avialbe.

Below you will find teh study guide. This time around its all hosted in GitHub so feel free to craete a pull request with updated links or resources. You can find the GitHub repo at https://github.com/PixelRobots/Azure-Study-Guides. 

---

## Links you may find useful
Here is a list of links that you mind find useful when studying for your Azure exams. Feel free to create a pull request to add more.
